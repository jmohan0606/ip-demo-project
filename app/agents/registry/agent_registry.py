...
class AgentRegistry:
    def __init__(self):
        agents=[SupervisorAgent(),ContextRetrievalAgent(),TigerGraphGraphAgent(),RagKnowledgeAgent(),PredictionAgent(),OpportunityAgent(),RecommendationAgent(),FeedbackLearningAgent(),ExplainabilityAgent(),AiAssistantAgent()]
