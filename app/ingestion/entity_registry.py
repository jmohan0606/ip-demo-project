...
ENTITY_CONFIGS: dict[str, IngestionEntityConfig] = {
    "advisor": IngestionEntityConfig(
        ...
        required_columns=["advisor_id", "advisor_name", "agp_enrolled", "status"],
    ...
    "account": IngestionEntityConfig(
        ...
        required_columns=["account_id", "account_type", "account_value", "status"],
    ),
    "transaction": IngestionEntityConfig(
        entity_name="transaction",
        csv_file_name="phx_dm_transaction.csv",
        primary_key="transaction_id",
        tigergraph_vertex="phx_dm_transaction",
        required_columns=[
            "transaction_id", "trade_date", "settlement_date", "transaction_type",
            "principal_amount", "revenue_amount", "advisor_id", "household_id",
            "account_id", "product_id", "period_id",
        ],
        batch_size=1000,
    ),
    "crm_activity": IngestionEntityConfig(
        ...
        required_columns=["activity_id", "activity_type", "activity_date", "advisor_id"],
    ),
    "agp_goal": IngestionEntityConfig(
        ...
        required_columns=["goal_id", "goal_name", "goal_type", "target_value", "advisor_id"],
    ),
    "kpi": IngestionEntityConfig(
        ...
        required_columns=["kpi_id", "kpi_name", "target_value", "current_value", "advisor_id"],
    ),
    "prediction": IngestionEntityConfig(
        ...
        required_columns=["prediction_id", "prediction_type", "score", "advisor_id"],
    ),
    "opportunity": IngestionEntityConfig(
        ...
        required_columns=["opportunity_id", "opportunity_type", "score", "advisor_id"],
    ),
    "recommendation": IngestionEntityConfig(
        ...
        required_columns=["recommendation_id", "recommendation_type", "status", "advisor_id"],
    ),
    "feedback": IngestionEntityConfig(
        ...
        required_columns=["feedback_id", "feedback_action", "reward_score", "recommendation_id"],
    ),
    "memory": IngestionEntityConfig(
        ...
        required_columns=["memory_id", "memory_type", "scope_type", "scope_id", "summary"],
    ),
    "document": IngestionEntityConfig(
        ...
        required_columns=["document_id", "document_name", "document_category", "status"],
    ),
    ...
    "embedding": IngestionEntityConfig(
        ...
        required_columns=["embedding_id", "entity_type", "entity_id", "embedding_type"],
    ),
}
